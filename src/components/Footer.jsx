...
const Footer = ({ onCareersClick, onContactClick, onAdminClick, onIpoClick, onAboutClick, onPortfolioClick, onServicesClick, onMutualFundsClick, onForexClick, onEquityClick }) => {
    return (
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-16 text-center md:text-left">
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        ...
                        <ul className="space-y-4 text-sm text-gray-400">
                            ...
                            <li><a href="#" onClick={(e) => { e.preventDefault(); if (onForexClick) onForexClick(); }} className="hover:text-corex-accent transition-colors">Forex Study</a></li>
                            <li><a href="#" onClick={(e) => { e.preventDefault(); if (onMutualFundsClick) onMutualFundsClick(); }} className="hover:text-corex-accent transition-colors">Mutual Funds</a></li>
                            <li><a href="#" onClick={(e) => { e.preventDefault(); if (onServicesClick) onServicesClick(); }} className="hover:text-corex-accent transition-colors">Our Services</a></li>
