                        ...
                        <div className="relative z-10 flex flex-col h-full">
                            ...
                            <div className="mt-auto pt-6 border-t border-slate-50 flex items-center justify-between">
                                ...
                                <button 
                                    ...
                                    className={`h-8 w-8 rounded-full flex items-center justify-center transition-all ${expandedFund === i ? 'bg-corex-navy text-white rotate-45' : 'bg-slate-50 hover:bg-purple-500 hover:text-white'}`}
                                >
